...
int main(){
    ...
    printf("\n\n---------------Exibindo comparação logica das cartas -------------\n");
    ...
    if(areaQuilometrosQuadrado1 > areaQuilometrosQuadrado2) {
        printf("cidade 1 tem mair aréa em Km².\n");
        rCidadeVencedora = 1;
    } else {
        printf("cidade 2 tem maior aréa em Km².\n");
        rCidadeVencedora = 2;
    }
    printf("A cidade vencedora é: %d\n", rCidadeVencedora);
    ...
    if (densidadePopulacionalHabKm1 < densidadePopulacionalHabKm2) {
        printf("cidade 1 com menor densidade populacional por Km².\n");
        rCidadeVencedora = 1;
    } else {
        printf("cidade 2 com menor densidade populacional por Km² .\n");
        rCidadeVencedora = 2;
    }
    printf("A cidade vencedora é: %d\n", rCidadeVencedora);

    if (numeroPibPerCapita1 > numeroPibPerCapita2) {
        printf("cidade 1 com maior pib per capita.\n");
        rCidadeVencedora = 1;
    } else {
        printf("cidade 2 com maior pib per capita.\n");
        rCidadeVencedora = 2;
    }
    printf("A cidade vencedora é: %d\n", rCidadeVencedora);

    if (superPoder1 > superPoder2) {
        printf("carta 1 com maior super poder.\n");
        rCartaVencedora = 1;
    } else {
        printf("carta 2 com maior super poder.\n");
        rCartaVencedora = 2;
    }
